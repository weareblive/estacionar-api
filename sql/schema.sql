...
(
  ...
  surface integer DEFAULT NULL,
  surface_format character varying (50) DEFAULT NULL,
  entrance_type character varying (50) DEFAULT NULL,
  entrance_height integer DEFAULT NULL,
  entrance_width integer DEFAULT NULL,
  between_street_1 character varying (100) DEFAULT NULL,
  between_street_2 character varying (100) DEFAULT NULL,
  with_roof boolean DEFAULT false,
  roof_height integer DEFAULT NULL,
